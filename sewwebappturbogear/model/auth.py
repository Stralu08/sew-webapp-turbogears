...
It's perfectly fine to re-use this definition in the sew-webapp-turbogear application,
though.
...
from sewwebappturbogear.model import DeclarativeBase, metadata, DBSession
