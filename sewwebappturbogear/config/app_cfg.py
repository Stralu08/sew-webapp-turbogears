# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in sew-webapp-turbogear.
...
import sewwebappturbogear
from sewwebappturbogear import model, lib
...
base_config.package = sewwebappturbogear
...
base_config.model = sewwebappturbogear.model
base_config.DBSession = sewwebappturbogear.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "588ea77e-dee8-4884-9b79-3fbc631f290a"
